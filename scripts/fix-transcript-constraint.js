...
// Use pooler connection string from env or construct it
const connectionString = `postgresql://postgres.quanxjvmlrgurucdyfmu:${dbPassword}@aws-0-ap-southeast-1.pooler.supabase.com:6543/${dbName}`;
